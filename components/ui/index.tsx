        ...
        <div className="text-card-foreground bg-primary/10 border-primary/20 relative isolate flex flex-col items-center justify-between gap-8 overflow-hidden rounded-xl border p-8 shadow-sm md:flex-row md:gap-12 md:px-10 md:py-20">
          ...
          <div className="mt-2 flex w-full max-w-xs shrink-0 justify-center md:mt-0 md:w-auto">
            {buttonLink ? (
              <a
                href={buttonLink}
                className="inline-flex h-12 w-full items-center justify-center rounded-lg bg-white px-8 text-base font-semibold text-[#01249D] shadow-[inset_0_2px_4px_rgba(255,255,255,0.5),inset_0_-2px_5px_rgba(0,0,0,0.1),0_8px_20px_rgba(0,0,0,0.1)] transition-transform hover:-translate-y-0.5 md:w-auto"
              >
                {buttonText}
                {buttonIcon && (
